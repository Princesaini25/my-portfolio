...
const Services = () => {
  return (
    /* Humne color ke aage ! lagaya hai taaki ye har purani setting ko force override kar de */
    <section className='bg-[#F8FAFC]! dark:bg-darklight! py-16 md:py-24' id='services'>
